...
public class IKInsectController : MonoBehaviour
{
    ...
    //     bool foundStep = Physics.Raycast(raycastOrigin, Vector3.down, out RaycastHit nextStep, 500, layerMask);
    ...
    //         Vector3 interDirection = RotateByQuaternion(targetMoveDirection.normalized, Quaternion.Euler(0, interAngle, 0));
    ...
    //                             {
    //                                 footIKTargets[i].position = MoveTo(footIKTargets[i].position, wayPoint[i] + Vector3.up * stepLift,
    //                                     Time.fixedDeltaTime, speed);
    //                             }
    //                             else //move feet directly to "wayPoint".
    //                             {
    //                                 footIKTargets[i].position = MoveTo(footIKTargets[i].position, wayPoint[i], Time.fixedDeltaTime, speed);
    //                             }
    //                         }
    ...
    //                         {
    //                             footIKTargets[i].position = MoveTo(footIKTargets[i].position, footIKTargets[i].stablePosition + Vector3.up * stepLift,
    //                                     Time.fixedDeltaTime, speed);
    //                         }
    //                         else //move feet directly to "wayPoint".
    //                         {
    //                             footIKTargets[i].position = MoveTo(footIKTargets[i].position, footIKTargets[i].stablePosition, Time.fixedDeltaTime, speed);
    //                         }
    //                     }
    ...
    public List<IKFootSolver> iKFootSolvers = new();
    ...
    private void OnValidate()
    {
        ...
        iKFootSolvers.Clear();
        iKFootSolvers = GetComponentsInChildren<IKFootSolver>().ToList();

        foreach (var iKFootSolver in iKFootSolvers)
        {
